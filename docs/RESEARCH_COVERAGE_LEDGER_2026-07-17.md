...
| Mostly complete - named closure gaps | 24 |
| Older/light work - corrected main pass required | 15 |
| Status/identity conflict | 7 |
| Intentionally low-priority/no-action | 2 |
| Out of scope | 0 |

Mandatory main-pass queue: 22 venues. This is the 15 older/light records plus
